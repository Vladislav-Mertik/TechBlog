    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library_system.author', verbose_name='Автор')),
            ],
            options={
                'verbose_name': 'Книга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library_system.book', verbose_name='Книга')),
            ],
            options={
                'verbose_name': 'Позика',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(through='library_system.Loan', to='library_system.book', verbose_name='Книги')),
            ],
            options={
                'verbose_name': 'Читач',
        ...
        migrations.AddField(
            model_name='loan',
            name='reader',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library_system.reader', verbose_name='Читач'),
        ),
    ]
